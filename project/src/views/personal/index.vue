    ...
    <div class="container">
        ...
        <div class="my_title_box">
            <div class="my_title" style="border:none;width:47.5%" v-if="info">
                ...
                <van-button type="" class="main_color_btn" size="small" @click="show = true" >返佣提款</van-button>
            </div>
            <div class="my_title" style="border:none;width:51%" v-if="info">
                ...
                <van-button type="" class="main_color_btn" size="small" @click="isShow = true" >兑换会员</van-button>
            </div>
        </div>
        <!-- <div class="xian"></div>         -->
        <div>
        ...
        <div style="text-align:center;padding-top:.4rem">
            <van-button @click="logout" class="main_color_btn">退出账号</van-button>
        </div>
