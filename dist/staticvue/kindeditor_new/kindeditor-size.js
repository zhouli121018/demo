...
function _getBasePath() {
	...
	return '/staticvue/kindeditor_new/'
	return '';
}
...
function _iframeDoc(iframe) {
	...
	return uiy.contentDocument || uiy.contentWindow.document;
}
var html, _direction = '';
...
_plugin('core', function(K) {
	...
	self.afterCreate(function() {
		...
		K(doc.body).bind('paste', function(e){
            //处理IE11,Chrome粘贴图片上传兼容代码start yzg2017-12-25
            function dopasteImg() {
                var file = null;
            ...
            if (dopasteImg())
                e.stop();
            //处理IE11,Chrome粘贴图片上传兼容代码end yzg2017-12-25
...
KindEditor.lang({
	...
	'fontname.fontName' : {
		...
		'Calibri' : 'Calibri',
		'Cambria' : 'Cambria',
		'Comic Sans MS, Comic Sans MS5, cursive' : 'Comic Sans',
		'Courier New, Courier New, monospace' : 'Courier',
		'Georgia, serif' : 'Georgia',
		'Impact, sans-serif' : 'Impact',
		'Lucida Console, Monaco, monospace' : 'Lucida Console',
		'MS PGothic' : 'MS PGothic',
		'Times New Roman, Times, serif' : 'Times New Roma',
	},
